---
name: a11y-audit
description: Accessibility audit skill using axe-core (runtime) and eslint-plugin-jsx-a11y (static). Checks WCAG 2.1 Level AA compliance, reports violations by severity (critical/serious/moderate/minor), and suggests fixes. Triggers on: "accessibility audit", "a11y", "WCAG compliance", "проверь доступность", "accessibility scan", "screen reader", "keyboard navigation".
---
